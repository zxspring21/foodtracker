...
class MealTableViewController: UITableViewController {
    ...
    // In this custom subclass, you can now define a property to store a list of Meal objects.
    
    //MARK: Properties
// You make the array mutable, which means you can add items to it after you initialize it.
    var meals = [Meal]()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        // Automatically adding the Editing button, and using the edit button item provided by the table view controller.
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        //count means numbers of items in array
        return meals.count
    }
